function callText(){
  ...
  var dtl=      
    '<div id="div_calltext" data-zoom=0 style="width:100%;height:'+(H_BODY-300)+'px;overflow:auto;text-align:center;padding:0px;background-color:white;">';
      ...
      for(var i=0;i<DB_CLIENTS.length;i++){
        ...
        dtl+=
          '<div style="width:100%;height:40px;margin-top:5px;padding:5px;text-align:left;font-size:12px;background-color:lightgray;">'+
            ...
            '<input onclick="callTextGO(&quot;call&quot;,&quot;'+DB_CLIENTS[i]['celno']+'&quot;)" type="image" src="'+vimgCall+'" style="float:right;text-align:right;padding:0px 5px 0 0;height:100%;margin-left:10px;background:none;" />'+
            '<input onclick="callTextGO(&quot;txt&quot;,&quot;'+DB_CLIENTS[i]['celno']+'&quot;)" type="image" src="'+vimgSms+'" style="float:right;text-align:right;padding:0px 5px 0 0;height:100%;background:none;" />'+
          '</div>'; 
      }
    dtl+='</div>';
